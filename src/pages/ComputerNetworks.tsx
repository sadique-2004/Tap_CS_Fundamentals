...
const ComputerNetworks = () => {
  const questions = [
    ...
    },
    {
      ...
      a: (
        <div className="space-y-6">
          ...
          <p className="font-bold">Fun way to memorize the 7 OSI layers 😎 <br /> AJJ PHIR SE TEST NAI DENA PADEGA </p>
    ...
    },
    {
      ...
      a: (
        <>
        <img src="https://tecadmin.net/wp-content/uploads/2023/06/tcp-ip-model.png" alt="" />
        </>
      ),
    },
    {
  ...
  a: (
    <div className="space-y-6">
      <ul className="list-disc ml-6 space-y-2">
        ...
        <li><strong>SMTP:</strong> Email transfer, port 25, always listening</li>
        <li><strong>DHCP:</strong> Auto-assign IP/subnet/DNS, port 67</li>
        <li><strong>FTP:</strong> File transfer, port 27</li>
        <li><strong>ICMP:</strong> Network diagnostics (ping), port 7</li>
        <li><strong>ARP:</strong> IP → MAC address resolution</li>
        <li><strong>RIP:</strong> Routing via hop-count, small/medium networks</li>
      </ul>
    </div>
  ),
}
  ...
  a: (
    <div className="space-y-4">
      <ul className="list-disc ml-6 space-y-2">
        ...
        <li>
          <strong>Switch:</strong> Data link layer, efficient, full-duplex, filters packets
        </li>
        <li>
          <strong>NIC:</strong> Connects PC → network, has unique MAC address
        </li>
      </ul>
    </div>
  ),
  ...
  a: (
    <div className="space-y-4">
      <ul className="list-disc ml-6 space-y-2">
        ...
        <li>
          <strong>Subnet:</strong> Network → subnets → better routing & security
        </li>
        <li>
  ...
  a: (
    <div className="space-y-4">
      <ul className="list-disc ml-6 space-y-2">
        ...
        <li>
          <strong>Reliability:</strong> Failure frequency, downtime, catastrophe
        </li>
        <li>
  ...
  a: (
    <div className="space-y-6">
      ...
      <ol className="list-decimal ml-6 space-y-3">
        <li>
          <span className="font-bold">Browser cache:</span> ✅ Shows fresh content if available
        </li>
        <li>
          <span className="font-bold">DNS lookup:</span> 🌐 Resolve domain → IP address
        </li>
        <li>
          <span className="font-bold">TCP three-way handshake:</span> 🤝 Connect to server
        </li>
        <li>
          <span className="font-bold">HTTP request & response:</span> 📤 Request sent → 📥 Server responds
        </li>
        <li>
          <span className="font-bold">Browser renders:</span> 🖥️ Display page & store in cache if needed
        </li>
      </ol>
