...
const DBMS = () => {
  ...
  const dbmsContent = [
    {  q: "Introduction to Database and DBMS",
      a: (
    ...
    {
      q: "ER Diagram (Entity-Relationship Model)",
      a: (
      ...
      a: (
        <div className="space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-300 text-sm">
              Breaking relations into smaller parts while keeping data
              consistent.
            </p>
          </div>
          ...
          <div className="bg-gray-800/60 backdrop-blur-md border border-gray-700 rounded-2xl p-6 shadow-xl hover:shadow-green-400/30 transition-all duration-300">
            ...
            <ul className="list-disc list-inside mt-3 text-gray-300">
              <li>
                <strong>Lossless Join:</strong> No data loss after decomposition
              </li>
              <li>
                <strong>Dependency Preservation:</strong> All functional
          ...
          <div className="overflow-x-auto">
            <table className="table-auto border border-collapse border-gray-300 w-full text-left bg-gray-900/50 rounded-xl shadow-lg">
              <thead className="bg-gray-700">
                <tr>
                  <th className="border px-4 py-2 text-green-300">
                    Normal Form
                  </th>
              ...
              <tbody>
                <tr className="hover:bg-gray-800 transition-colors">
                  <td className="border px-4 py-2 font-semibold text-white">
                    1NF
                  </td>
            ...
            <table className="table-auto border border-collapse border-gray-300 w-full text-left bg-gray-900/50 rounded-xl shadow-lg">
              <thead className="bg-gray-700">
                <tr>
                  ...
                  <th className="border px-4 py-2 text-purple-300">
                    Description
                  </th>
                </tr>
              </thead>
      ...
      a: (
        <div className="space-y-6">
          ...
          <div className="bg-gray-800/60 backdrop-blur-md border border-gray-700 rounded-2xl p-6 shadow-xl">
            ...
            <ul className="list-disc list-inside text-gray-300">
              <li>
                Conflict Serializable: Equivalent to serial schedule by swapping
            ...
            <table className="table-auto border border-collapse border-gray-300 w-full text-left">
              ...
              <tbody>
                <tr className="hover:bg-gray-800">
                  ...
                  <td className="border px-4 py-2 text-gray-300">
                    Commit depends on prior commit
                  </td>
                </tr>
                <tr className="hover:bg-gray-800">
                  <td className="border px-4 py-2 font-semibold text-white">
                  ...
                  <td className="border px-4 py-2 text-gray-300">
                    Failure causes rollback of others
                  </td>
                </tr>
                <tr className="hover:bg-gray-800">
                  <td className="border px-4 py-2 font-semibold text-white">
      ...
      a: (
        <div className="space-y-6">
          ...
          <p className="text-gray-300 mt-2">
            Extended Operators: Intersection (∩), Natural Join (⋈), Outer Join
            (⟕, ⟖, ⟗), Division (/)
          </p>
        </div>
      ),
